...
- [Learning Python](http://dmccreary.github.io/learning-python/) - focus on basic turtle graphic and extensive MicroSims
- [Learning MicroPython](http://dmccreary.github.io/learning-micropython/) - focus on fun physical computing tasks and a low-cost kit built around the $4 Raspberry Pi Pico on a breadboard
- [Moving Rainbow](http://dmccreary.github.io/moving-rainbow/) - built around a $15 kit with a Raspberry Pi Pico on a breadboard and a fun colorful LED strip or LED matrix.  Also includes LED Noodle Projects.  Many examples of patterns that are used in halloween costumes.
