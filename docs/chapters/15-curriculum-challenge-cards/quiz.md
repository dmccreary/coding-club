...
1. A digital badge awarded for completing a skill
2. A record of a student's finished projects over time
3. A chart showing which skills build on which others
4. A single printed or digital card describing one hands-on project, with a title, difficulty level, materials list, and numbered steps
</div>
...
<div class="upper-alpha" markdown>
1. An online coding platform that runs without an internet connection
2. A computational thinking concept taught through a physical, screen-free activity, such as giving a student step-by-step verbal instructions to walk a path
3. A challenge card printed without a colored border
4. A live coding demonstration performed without a projector
</div>
...
??? question "Show Answer"
    ...
    **Concept Tested:** Unplugged Coding Activity
    **See:** [Unplugged Coding Activity](../../glossary.md#unplugged-coding-activity)
...
<div class="upper-alpha" markdown>
1. A curriculum where every student in a track must advance in lockstep on the same day
2. A pacing guide used only by professional mentors
3. A path that lets a faster or slower student move through a curriculum sequence at their own speed rather than everyone advancing together
4. A single challenge card designed for advanced students only
</div>
...
??? question "Show Answer"
    ...
    **Concept Tested:** Self Paced Learning Path
    **See:** [Self Paced Learning Path](../../glossary.md#self-paced-learning-path)
...
<div class="upper-alpha" markdown>
1. Because beginner-track students are not allowed to work with partners
2. Because it is most effective once a student has enough working code to actually review
3. Because peer code review requires a professional mentor to supervise it
4. Because the beginner track uses only unplugged activities with no code at all
</div>
...
??? question "Show Answer"
    ...
    **See:** [Peer Code Review](../../glossary.md#peer-code-review)
...
<div class="upper-alpha" markdown>
1. Because black-bordered cards are more expensive to print than green or blue cards
2. Because advanced cards are legally restricted to one student at a time
3. Because it naturally pushes two students drawn to the same card toward pair programming, since they have every reason to work through it together
4. Because advanced students are not allowed to use self-paced learning paths
</div>
...
??? question "Show Answer"
    ...
    **See:** [Pair Programming](../../glossary.md#pair-programming)
...
<div class="upper-alpha" markdown>
1. In a code-along session every student types the same code as a mentor in sync, while a live coding demonstration is the mentor-led version without student typing
2. They are two names for the exact same practice
3. A code-along session only happens on the advanced track
4. A live coding demonstration requires students to work in pairs
</div>
...
??? question "Show Answer"
    ...
    **Concept Tested:** Live Coding Demonstration
    **See:** [Live Coding Demonstration](../../glossary.md#live-coding-demonstration)
...
<div class="upper-alpha" markdown>
1. Mixed age grouping cannot occur across different curriculum tracks
2. The club has made a mistake, since track placement should always match a student's age
3. The older student must be moved to the advanced track within one term
4. Tracks are placed by demonstrated skill, not by a student's age or how long they've attended the club
</div>
...
??? question "Show Answer"
    ...
    **Concept Tested:** Beginner Track Curriculum
    **See:** [Beginner Track Curriculum](../../glossary.md#beginner-track-curriculum)
...
<div class="upper-alpha" markdown>
1. An online coding platform, because it lowers the setup barrier for shared devices
2. A code-sharing platform, because it requires the least amount of setup
3. An offline coding environment, a downloaded editor that works better without reliable internet or when new software installs are restricted
4. A skill badge system, because it does not depend on internet access
</div>
...
??? question "Show Answer"
    ...
    **Concept Tested:** Offline Coding Environment
    **See:** [Offline Coding Environment](../../glossary.md#offline-coding-environment)
...
<div class="upper-alpha" markdown>
1. Students who have mastered most of the introductory concepts in a track like Scratch, Python, or MicroPython
2. First-time students with no prior track experience
3. Only mentors demonstrating a live coding session
4. Students working exclusively on unplugged activities
</div>
...
??? question "Show Answer"
    ...
    **Concept Tested:** Printing Challenge Cards
    **See:** [Printing Challenge Cards](../../glossary.md#printing-challenge-cards)
...
<div class="upper-alpha" markdown>
1. The root cause is a missing mentor-gated enrollment cap; the fix is closing registration early
2. The root cause is poor noise level management; the fix is adding acoustic panels to the room
3. The root cause is the student being placed in the wrong curriculum track; the fix is moving her to the advanced track immediately
4. The root cause is a missing stretch goal on the card; every challenge card needs one so a fast-finishing student always has something left to build
</div>
...
??? question "Show Answer"
    ...
    **Concept Tested:** Designing Challenge Cards
    **See:** [Designing Challenge Cards](../../glossary.md#designing-challenge-cards)
