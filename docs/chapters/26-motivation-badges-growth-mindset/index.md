---
title: Motivation, Badges, and Growth Mindset Coaching
description: Covers the psychology behind badge and reward systems, careful competition design that avoids demotivating strugglers, and growth-mindset coaching language for celebrating wins and recovering from setbacks.
generated_by: claude skill chapter-content-generator
date: 2026-09-01 07:22:57
metadata:
  ibook:
    version: 1.10
---
...
!!! mascot-welcome "Turning showing up into wanting to show up"
...
!!! mascot-thinking "Adding a reward can sometimes remove one"
...
!!! mascot-tip "Name every badge after the skill it proves"
...
!!! mascot-warning "A leaderboard can tell your slowest student they're always last"
...
!!! mascot-encourage "That reaction is completely normal -- most builders hit this wall"
...
!!! mascot-tip "Catch the win in the first ten minutes"
    ![Circuit giving a tip](../../img/mascot/tip.png){ class="mascot-admonition-img" }
