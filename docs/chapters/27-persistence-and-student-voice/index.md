---
title: Encouraging Persistence and Student Voice
description: Covers the day-to-day emotional coaching of mentoring -- reading frustration, coaching persistence, and reframing failure as data -- alongside the structures that give students real voice and choice over their own goals and projects.
generated_by: claude skill chapter-content-generator
date: 2026-09-01 07:31:44
metadata:
  ibook:
    version: 1.10
---
...
- [26. Motivation, Badges, and Growth Mindset Coaching](../26-motivation-badges-growth-mindset/index.md)
...
!!! mascot-welcome "The two minutes that decide whether a student comes back"
...
!!! mascot-encourage "Reading frustration correctly is hard for mentors too, not just students"
...
<iframe src="../../sims/frustration-escalation-response-flow/main.html" width="100%" height="662px" scrolling="no"></iframe>

<details markdown="1">
<summary>Frustration Escalation Response Flow</summary>
Type: workflow
...
!!! mascot-tip "Praise the process, not just the outcome"
...
!!! mascot-thinking "Choice isn't the reward -- it's the fuel"
...
!!! mascot-warning "Collecting a student interest survey and then ignoring it is worse than not asking"
