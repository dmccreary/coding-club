---
title: "Stories"
description: "Illustrated graphic-novel stories connecting Coding Club lessons to grounded club case studies and the founders of the coding-club movement"
...
-   **[The Broken Wires on the Motors](./broken-wires/index.md)**
    ...
    ![The Broken Wires on the Motors](./broken-wires/cover.png)
...
-   **[Lights, Color, Motion!](./lights-color-motion/index.md)**
    ...
    ![Lights, Color, Motion!](./lights-color-motion/panel-01.png)
...
-   **[The Empty Chair](./empty-chair/index.md)**
    ...
    ![The Empty Chair](./empty-chair/cover.png)
...
-   **[The Unfamiliar Face at the Door](./unfamiliar-face-at-door/index.md)**
    ...
    ![The Unfamiliar Face at the Door](./unfamiliar-face-at-door/cover.png)
...
-   **[The Waiting List](./waiting-list/index.md)**
    ...
    ![The Waiting List](./waiting-list/cover.png)
...
-   **[The Sticky Notes on the Whiteboard](./sticky-notes-whiteboard/index.md)**
    ...
    ![The Sticky Notes on the Whiteboard](./sticky-notes-whiteboard/cover.png)
...
-   **[The Bus That Never Came](./bus-that-never-came/index.md)**
    ...
    ![The Bus That Never Came](./bus-that-never-came/cover.png)
...
-   **[The Grant That Almost Wasn't](./grant-that-almost-wasnt/index.md)**
    ...
    ![The Grant That Almost Wasn't](./grant-that-almost-wasnt/cover.png)
...
-   **[The Notebook Dan Left Behind](./notebook-dan-left-behind/index.md)**
    ...
    ![The Notebook Dan Left Behind](./notebook-dan-left-behind/cover.png)
...
-   **[The Agent That Answered at Midnight](./agent-answered-at-midnight/index.md)**
    ...
    ![The Agent That Answered at Midnight](./agent-answered-at-midnight/cover.png)
...
-   **[First Steps Across the Threshold](./first-steps-across-threshold/index.md)**
    ...
    ![First Steps Across the Threshold](./first-steps-across-threshold/cover.png)
...
-   **[Turtles All the Way Down](./turtles-all-the-way-down/index.md)**
    ...
    ![Turtles All the Way Down](./turtles-all-the-way-down/cover.png)
...
-   **[Imagine, Create, Share, Reflect](./imagine-create-share-reflect/index.md)**
    ...
    ![Imagine, Create, Share, Reflect](./imagine-create-share-reflect/cover.png)
...
-   **[The Garage Where Everyone Was Welcome](./garage-where-everyone-was-welcome/index.md)**
    ...
    ![The Garage Where Everyone Was Welcome](./garage-where-everyone-was-welcome/cover.png)
...
-   **[Each One Teach One](./each-one-teach-one/index.md)**
    ...
    ![Each One Teach One](./each-one-teach-one/cover.png)
...
-   **[Code for Every Kid](./code-for-every-kid/index.md)**
    ...
    ![Code for Every Kid](./code-for-every-kid/cover.png)
...
-   **[The Clubhouse With No Locked Doors](./clubhouse-with-no-locked-doors/index.md)**
    ...
    ![The Clubhouse With No Locked Doors](./clubhouse-with-no-locked-doors/cover.png)
