...
| 5 | Chapter Quizzes | 0 / 35 | Recommended | Chapters with a quiz.md (0 questions total) |
| 6 | Chapter References | 0 / 35 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 0 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 0 | Recommended | Questions in faq.md |
| 9 | Words | 115,984 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 87 | 87 | H4 headers starting with '#### Diagram:' |
| Equations | 3 | 0 | LaTeX expressions (inline and display) |
| Total Words | 115,984 | 110,857 | Words in markdown files |
| Links | 299 | 235 | Hyperlinks in markdown format |
| Equivalent Pages | 486 | 465 | Estimated pages (250 words/page + visuals) |
