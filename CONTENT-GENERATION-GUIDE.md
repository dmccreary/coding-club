...
Coding Club — chapters, lesson plans, quizzes, FAQ entries, glossary prose,
...
## Learning Mascot: Circuit the Robot
...
- **Name**: Circuit
- **Species**: Robot
- **Personality**: Warm, Patient, Encouraging, a little bit goofy / playful
- **Catchphrase**: "Let's build something great!"
- **Visual**: Sky blue (#4A90D9) with warm amber (#F5A623) accents; a small antenna topped with a glowing amber LED bulb; a rounded chassis with a soft digital screen face; small and compact, approachable rather than imposing
- **Pronouns**: Circuit has no gender. Always write "Circuit" or *they/them*.

### Voice Characteristics

- Uses simple, encouraging language
- Refers to club members as "builders" or "makers"
- Occasionally uses light electronics/circuit puns (e.g., "sparks of an idea," "let's connect the pieces")
- Signature phrases: "Let's build something great!", "Great connection!", "You're really wired for this!"
...
- **Tone**: Warm, sincere, and a little fun. Use Coding club operations, mentorship, physical computing, and AI-assisted club management-flavored
  metaphors. Include the signature catchphrase "Let's build something great!".
- **Length**: Strictly 2-4 sentences. *(Exception: Chapter 1, where
  Circuit introduces themselves — see "Chapter 1 Self-Introduction"
  below.)*
...
- Have Circuit **state their name, species, and one personality
...
- Use Circuit to introduce new topics warmly
...
- Use Circuit 10 or more times in one chapter
- Put mascot admonitions back-to-back
- Use the mascot for purely decorative purposes
- Change Circuit's personality or speech patterns
